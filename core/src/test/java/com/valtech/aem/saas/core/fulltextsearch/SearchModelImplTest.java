...
class SearchModelImplTest {
  ...
  void testAdaptRequest() {
    ...
    assertThat(testee.getSearchButtonText(), is(SearchModelImpl.I18N_KEY_SEARCH_BUTTON_LABEL));
    assertThat(testee.getLoadMoreButtonText(), is(SearchTabModelImpl.I18N_KEY_LOAD_MORE_BUTTON_LABEL));
