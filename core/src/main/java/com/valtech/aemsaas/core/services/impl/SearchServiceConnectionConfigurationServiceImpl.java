...
@Component(name = "VALTECH - Search Service Connection Configuration Service",
    immediate = true,
...
public class SearchServiceConnectionConfigurationServiceImpl implements SearchServiceConnectionConfigurationService {
  ...
  @ObjectClassDefinition(name = "Search Service HTTP Connection Configuration", description = "URL and credentials to connect to Search as a Service (SAAS).")
  public @interface Configuration {

    String DEFAULT_WEB_SERVICE_URL = "https://test-search.infocentric.swiss"; //this value needs to be updated
    ...
    boolean searchService_basicAuthentication_enable() default FALSE;
    ...
    @AttributeDefinition(name = "Ignore invalid SSL certificate",
        ...
        type = AttributeType.BOOLEAN)
    boolean searchService_ignoreSSL() default FALSE;
